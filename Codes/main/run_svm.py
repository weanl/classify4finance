...
def run_mc_svm(config):
    ...
    param_grid = {
        ...
        "kernel": ["rbf"],
        "C": [16384*4, 16384*8, 16384*16, 16384*32, 16384*64, 16384*128],
        "gamma": [1/960/8, 1/960/7, 1/960/6, 1/960/5, 1/960/4, 1/960/3],
        # 1/n_features = 1/15/64 = 1/960
    }
    model = SVC(
